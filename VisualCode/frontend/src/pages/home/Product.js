                                    ...
                                    .map((pr, index) => (
                                        <div className="showcase" key={index}>
                                            ...
                                            <a href="#" className="showcase-img-box">
                                                <img src={"./assets/images/products/" + pr.image_one} alt="baby fabric shoes" width="75" height="75"
                                            ...
                                            .map((item, index) => (
                                                <div className="showcase" key={index}>
                                                    <a href="#" className="showcase-img-box">
                                                        ...
                                                        <img
                                                            key={index}
                                                            src={"./assets/images/products/" + item.image_one}
                                    ...
                                    {dataLoaded &&
                                        getTopRatedProducts()
                                            ...
                                            .map((item, index) => (
                                                <div className="showcase" key={index}>
                                                    <a href="#" className="showcase-img-box">
                                                        <img src={"./assets/images/products/" + item.image_one}
                                                            alt={`Product Image ${index + 1}`}
                                                            className="showcase-img"
                                                            width="70"
                                                        />
                                    ...
                                    .map((pr, index) => (
                                        <div className="showcase" key={index}>
                                            ...
                                            <div className="showcase-banner">
                                                <img src={"./assets/images/products/" + pr.image_one} alt="shampoo, conditioner & facewash packs" className="showcase-img" />
                                            </div>
                                ...
                                .map((pr, index) => (
                                    <div className="showcase" key={pr.id}>
                                        ...
                                        <div className="showcase-banner" key={index}>
                                            ...
                                            <img src={"./assets/images/products/" + pr.image_one} alt="Mens Winter Leathers Jackets" width="300" className="product-img default" />
                                            <img src={"./assets/images/products/" + pr.image_two} alt="Mens Winter Leathers Jackets" width="300" className="product-img hover" />
